    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        {type === "password" && (
          <div className="text-sm">
            <a
              href="#"
              className="font-semibold text-secondary-300 hover:text-secondary-200"
            >
              Forgot password?
            </a>
          </div>
      ...
      <div className="mt-2">
        <input
          ...
          className="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-secondary-500 sm:text-sm/6"
        />
      </div>
    </div>
  );
